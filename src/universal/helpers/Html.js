    ...
    return (
      <html lang="en-us">
        <head>
          ...
          { Object.keys(assets.styles).length === 0 ? <style dangerouslySetInnerHTML={{__html: require('../theme/bootstrap.config.js') + require('./../containers/AppContainer/AppContainer.scss')._style}}/> : null }
        </head>
        <body>
          ...
          <script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/codemirror/5.9.0/mode/htmlmixed/htmlmixed.min.js" charSet="UTF-8"/>
        </body>
      </html>
    );
  }
